...
all_data[,annual_drive_failure_rate := sprintf("%1.2f%%", 100*annual_drive_failure_rate)]
all_data[,annual_drive_failure_rate_95 := sprintf("%1.2f%%", 100*annual_drive_failure_rate_95)]
...
```{r data}
knitr::kable(all_data[,list(
  model, capacity_tb, 
  annual_drive_failure_rate,
  annual_drive_failure_rate_95)])
```
