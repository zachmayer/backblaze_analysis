...
best_model <- prices[1,]
best_model_name <- rev(stringi::stri_split_fixed(best_model$model, ' ')[[1]])[1]
...
[Check prices on ebay](`r sprintf("https://www.ebay.com/sch/i.html?_from=R40&_nkw=%s&_sacat=0&LH_BIN=1&_sop=15&rt=nc&LH_ItemCondition=1000|1500", best_model_name)`).
