...
setorder(capacity_order, -capacity)
capacity_order[,size :=  factor(size, levels=size, ordered=T)]

capacity_map = fread('results/capacity_map.csv')
capacity_map = merge(capacity_map, capacity_order, by='capacity')
...
knitr::kable(
  dat[1:top_n,
    list(
      ...
      drive_days,
      failures=failed,
      years_pct97pct=sprintf("%1.1f", years_97pct),
