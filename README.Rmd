...
# Data Sources
I'm buying a hard drive for backups, and I want to buy a drive that's not going to fail. I'm going to use data from [BackBlaze](https://www.backblaze.com/b2/hard-drive-test-data.html#downloading-the-raw-hard-drive-test-data) to assess drive reliability.
...
```
I'm probably way over-thinking this, but it was fun to analyze the data.  Any of the top `r top_n` drives are likely safe to buy, and are very unlikely to fail as I use them for a backup drive.
