...
I wanted to pick my drive based on: `lower 95% confidence interval for median time to failure`.  In other words, I want to pick the drive that has the most evidence it will last a large number of days.
