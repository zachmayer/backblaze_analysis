...
1.  Run [code/1_download_data.R](1_download_data.R) to download the data (almost 10.5 GB).    
2.  Run [code/2_unzip_data.R](2_unzip_data.R) to unzip the data (almost 55 GB).    
3.  Run [code/3_assemble_data.R](3_assemble_data.R) to "compress" the data, which generates [all_data.csv](all_data.csv).    
4.  Run [code/4_survival_analysis.R](4_survival_analysis.R) to calculate 5 year survival.
